...
3. Start `/system/bin/bombd` from `/system/etc/init/bombd.rc` in its own
...
bombd_exec     /system/bin/bombd entry point
...
adb shell ls -Z /system/bin/bombd /data/system/bomb
