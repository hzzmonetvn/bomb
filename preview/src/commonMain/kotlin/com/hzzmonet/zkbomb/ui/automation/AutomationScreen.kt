...
fun LazyListScope.automationContent(navigator: BombNavigator) {
    item {
        BombCard {
    ...
    item {
        BombUnsupportedState(
            title = "Rule execution backend",
            reason = "Rules are planned but the background trigger service is not integrated yet.",
        )
    }
